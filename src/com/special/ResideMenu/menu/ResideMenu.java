...
public class ResideMenu extends FrameLayout implements GestureDetector.OnGestureListener{
    ...
    private void initViews(Context context){
        ...
        inflater.inflate(com.melchor629.musicote.R.layout.residemenu, this);
        sv_menu = (ScrollView) findViewById(com.melchor629.musicote.R.id.sv_menu);
        iv_shadow = (ImageView) findViewById(com.melchor629.musicote.R.id.iv_shadow);
        layout_menu = (LinearLayout) findViewById(com.melchor629.musicote.R.id.layout_menu);
        iv_background = (ImageView) findViewById(com.melchor629.musicote.R.id.iv_background);
    }
    ...
    public void setShadowVisible(boolean isVisible){
        if (isVisible)
            iv_shadow.setImageResource(com.melchor629.musicote.R.drawable.shadow);
        else
