...
public abstract class DB_entry implements BaseColumns {
	...
	public static final String TABLE_ULTIMO_ACCESO = "ultimo_acceso";
	...
	public static final String COLUMN_NAME_TABLA = "tabla";
	...
	public static final String CREATE_ULTIMO_ACCESO = "CREATE TABLE IF NOT EXISTS " + TABLE_ULTIMO_ACCESO + " (" + COLUMN_NAME_TABLA + " UNIQUE,"
			+ " " + COLUMN_NAME_FECHA + ");";
	public static final String DELETE_ULTIMO_ACCESO = "DROP TABLE IF EXISTS " + TABLE_ULTIMO_ACCESO;
